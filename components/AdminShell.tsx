...
import { LayoutDashboard, Type, BookOpen, Bell, MapPin, Brain, Users, User, LogOut, ChevronRight, ClipboardList, Menu, X, Settings2, BellRing, Package, Images } from 'lucide-react'

const nav = [
  { href:'/admin/dashboard', label:'Dashboard', icon:LayoutDashboard },
  { href:'/admin/content', label:'Site Content', icon:Type },
  { href:'/admin/library', label:'Library', icon:BookOpen },
  { href:'/admin/materials', label:'Ministry Materials', icon:Package },
    ...
    <div className="flex min-h-screen bg-[#f9f9f7]">
      ...
      {drawerOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 bg-[#0a0a0a] h-full flex flex-col animate-slide-up z-10">
      ...
      {/* Mobile header */}
      <header className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-[#0a0a0a] px-4 py-3 flex items-center justify-between border-b border-white/5">
