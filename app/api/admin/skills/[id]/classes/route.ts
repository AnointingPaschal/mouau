...
export async function PUT(req: NextRequest) {
  ...
  const { data } = await supabase.from('skill_classes').update(updates).eq('id', id).select().single()
...
export async function DELETE(req: NextRequest) {
  ...
  await supabase.from('skill_classes').delete().eq('id', id)
