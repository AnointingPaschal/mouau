...
export default async function manifest(): Promise<MetadataRoute.Manifest> {
  ...
  // Build icon list: if admin uploaded a custom logo, add it first at all
  // standard sizes so every browser picks it up for the install prompt & splash.
  const uploadedIcons: MetadataRoute.Manifest['icons'] =
