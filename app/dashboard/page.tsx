  ...
  return (
    <AppShell>
      ...
      <div className="p-4 lg:p-6 w-full space-y-5 pb-24 lg:pb-6 animate-fade-in">
        ...
        {/* Pneuma Domain Gallery */}
        <div>
          <div className="flex items-center justify-between mb-3">
            <div className="section-label">PNEUMA DOMAIN GALLERY</div>
            <Link href="/library" className="text-[10px] font-bold text-[#1e3a8a]">View Library →</Link>
          </div>
          <GallerySlideshow/>
        </div>
